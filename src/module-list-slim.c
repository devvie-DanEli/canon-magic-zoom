...
static char *slim_module_core_names[] =
{
    "mlv_lite",
    "crop_rec",
    "mlv_play",
...
static void slim_module_lowercase(char *name)
{
    while (*name)
    {
        if (*name >= 'A' && *name <= 'Z')
...
static void slim_module_scan(void)
{
    ...
    do
    {
        ...
        if (dot) *dot = '\0';
        slim_module_lowercase(item->name);
...
static MENU_SELECT_FUNC(slim_module_toggle)
{
    ...
    slim_module_enable_file(
        slim_modules[index].name, enable_file, sizeof(enable_file));
    config_flag_file_setting_save(enable_file, slim_modules[index].enabled);
    menu_redraw();
}
...
{
    SLIM_MODULE_ENTRY(0)  SLIM_MODULE_ENTRY(1)  SLIM_MODULE_ENTRY(2)  SLIM_MODULE_ENTRY(3)
    SLIM_MODULE_ENTRY(4)  SLIM_MODULE_ENTRY(5)  SLIM_MODULE_ENTRY(6)  SLIM_MODULE_ENTRY(7)
    SLIM_MODULE_ENTRY(8)  SLIM_MODULE_ENTRY(9)  SLIM_MODULE_ENTRY(10) SLIM_MODULE_ENTRY(11)
    SLIM_MODULE_ENTRY(12) SLIM_MODULE_ENTRY(13) SLIM_MODULE_ENTRY(14) SLIM_MODULE_ENTRY(15)
    SLIM_MODULE_ENTRY(16) SLIM_MODULE_ENTRY(17) SLIM_MODULE_ENTRY(18) SLIM_MODULE_ENTRY(19)
    SLIM_MODULE_ENTRY(20) SLIM_MODULE_ENTRY(21) SLIM_MODULE_ENTRY(22) SLIM_MODULE_ENTRY(23)
    SLIM_MODULE_ENTRY(24) SLIM_MODULE_ENTRY(25) SLIM_MODULE_ENTRY(26) SLIM_MODULE_ENTRY(27)
    SLIM_MODULE_ENTRY(28) SLIM_MODULE_ENTRY(29) SLIM_MODULE_ENTRY(30) SLIM_MODULE_ENTRY(31)
    SLIM_MODULE_ENTRY(32) SLIM_MODULE_ENTRY(33) SLIM_MODULE_ENTRY(34) SLIM_MODULE_ENTRY(35)
    SLIM_MODULE_ENTRY(36) SLIM_MODULE_ENTRY(37) SLIM_MODULE_ENTRY(38) SLIM_MODULE_ENTRY(39)
    SLIM_MODULE_ENTRY(40) SLIM_MODULE_ENTRY(41) SLIM_MODULE_ENTRY(42) SLIM_MODULE_ENTRY(43)
    SLIM_MODULE_ENTRY(44) SLIM_MODULE_ENTRY(45) SLIM_MODULE_ENTRY(46) SLIM_MODULE_ENTRY(47)
    SLIM_MODULE_ENTRY(48) SLIM_MODULE_ENTRY(49) SLIM_MODULE_ENTRY(50) SLIM_MODULE_ENTRY(51)
    SLIM_MODULE_ENTRY(52) SLIM_MODULE_ENTRY(53) SLIM_MODULE_ENTRY(54) SLIM_MODULE_ENTRY(55)
    SLIM_MODULE_ENTRY(56) SLIM_MODULE_ENTRY(57) SLIM_MODULE_ENTRY(58) SLIM_MODULE_ENTRY(59)
    SLIM_MODULE_ENTRY(60) SLIM_MODULE_ENTRY(61) SLIM_MODULE_ENTRY(62) SLIM_MODULE_ENTRY(63)
};
